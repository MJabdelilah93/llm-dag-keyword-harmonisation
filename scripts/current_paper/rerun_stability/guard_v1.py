"""Verified v1 G1-G4 guard logic, shared by the rerun-stability harness.
Identical to scripts/current_paper/reparse_dev_log_v1.py's implementation
(independently re-verified against real evidence in Phase 0B Task 4) --
duplicated here rather than imported across the rerun_stability/
subpackage boundary, to keep this harness self-contained and auditable as
a single unit.
"""
import json
import re
