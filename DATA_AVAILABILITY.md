...
| Software version series (concept DOI) | `10.5281/zenodo.20931435` | Open | Zenodo concept DOI representing all software versions in this record and resolving to the latest published version. |
| Historical: v1.0.0 version-specific software archive, prior pre-strengthening submission | `10.5281/zenodo.20931436` | Open (historical) | Version-specific DOI for the original pre-strengthening software release; describes an earlier, different version of this software, not the strengthened evidence base in this repository revision. Do not cite for v2.0.0. |
